...
- `src/lib/finance/calculations.ts` — todas as regras de negócio como funções puras (cortes de pagamento, mês quitado, totais, projeção, DRE, CSV), independentes da fonte de dados. Cobertas por `calculations.test.ts` (`npm test`).
